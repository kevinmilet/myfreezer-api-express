...
db.Freezer.belongsTo(db.User, { foreignKey: 'id' });

db.FreezerType.hasMany(db.Freezer, { foreignKey: 'freezer_type_id' });
db.Freezer.belongsTo(db.FreezerType, { foreignKey: 'id' });

db.ProductType.hasMany(db.Product, { foreignKey: 'product_type_id' });
db.Product.belongsTo(db.ProductType, { foreignKey: 'id' });

db.User.hasMany(db.Product, { foreignKey: 'user_id' });
db.Product.belongsTo(db.User, { foreignKey: 'id' });

db.Freezer.hasMany(db.Product, { foreignKey: 'freezer_id' });
db.Product.belongsTo(db.Freezer, { foreignKey: 'id' });
